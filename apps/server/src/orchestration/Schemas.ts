import {
  ...
  ThreadProjectUpdatedPayload as ContractsThreadProjectUpdatedPayloadSchema,
...
export const ThreadProjectUpdatedPayload = ContractsThreadProjectUpdatedPayloadSchema;
