...
export type RelocateProjectInput = CommandInput<"project.relocate">;
...
export const relocateProject: (input: RelocateProjectInput) => CommandEffect = Effect.fn(
  "EnvironmentCommands.relocateProject",
)(function* (input) {
  return yield* dispatch({
    ...input,
